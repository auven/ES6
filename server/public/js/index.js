...
/***/ (function(module, exports) {
...

	{
	  ...
	  console.log('size', _list, _list.size);
	}
...

	{
	  ...
	  console.log('has', _list3.has('add'), _list3);
	...
	{
	  var weakList = new WeakSet(); // WeakSet与Set支持的数据类型不一样，WeakSet参数必须是对象，是地址引用，不会考虑是否被垃圾回收... 没有clear方法，没有set属性，不能遍历
...

	{
	  ...
	  console.info('map-array-add', _map2, array);
	  ...
	  console.log('map-array-delete', _map2, array);
	}
...

	{
	  ...
	  console.info('set-array-find', set_exist, _array_exist);
	  ...
	  console.log('map-array-delete', set, _array);
	}
...

	{
	  ...
	  console.log('map-set-object', _map3, _set, obj);
